...
-- Create ENUM type for the continent column in the country table
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'continent_enum') THEN
        CREATE TYPE continent_enum AS ENUM ('Asia','Europe','North America','Africa','Oceania','Antarctica','South America');
    END IF;
END$$;

-- Create table "country" first since it is referenced by other tables.
DROP TABLE IF EXISTS "country" CASCADE;

CREATE TABLE "country" (
  "Code" char(3) NOT NULL DEFAULT '',
  "Name" char(52) NOT NULL DEFAULT '',
  "Continent" continent_enum NOT NULL DEFAULT 'Asia',
...
-- (Optional) Create an index on "CountryCode" if needed.
...
-- (Optional) Create an index on "CountryCode" for countrylanguage if desired.
CREATE INDEX idx_countrylanguage_countrycode ON "countrylanguage" ("CountryCode");

-- Insert a sample record into "countrylanguage"
